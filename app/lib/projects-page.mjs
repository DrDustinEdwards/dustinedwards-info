 ...
 * `build:stack`, byte-gated by `check:stack`, and already imported by the
 * colophon, so the gate count reaches this card through the same pipe the
 * colophon reads and costs the Worker nothing new. `PHAGE_YEARS` is the data
