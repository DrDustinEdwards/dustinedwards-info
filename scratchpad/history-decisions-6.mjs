...
export default {
  ...
  238: ["WHY", "trimmed to two lines", "The palette, hung under its bar. --surface-popover with --border-strong (hard rule 5)."],
  ...
  684: ["WHY", "vendored note compressed to one line", "Placeholder: semi-transparent current text colour, where color-mix() with currentcolor does not crash."],
};
