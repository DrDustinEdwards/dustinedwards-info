...
// almost entirely boundary statement: what a gate CANNOT see, and what the number is NOT.
// organisms#0 and phage-hunters#0 are the opposite shape from everything else in the wave:
// their bulk is a REVIEWED EXCLUSION LIST and a ruling about a real person's name, both of which
// are the decision itself rather than the story of it, so both keep their substance.
export default {
