...
/* 62 against 66, re-measured 2026-09-04 by RUNNING the gate after the fixed
   window case landed. The file floor catches a file LEAVING; this one catches a
   file being hollowed out in place, which no file count can see. */
const MINIMUM_CASES = 62;
