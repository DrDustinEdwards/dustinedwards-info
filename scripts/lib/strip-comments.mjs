 ...
 * text is read as a string only when a matching quote closes it on the same line; for anything that
 * must be exact, read the syntax tree (scripts/lib/syntax.mjs) instead.
 */
