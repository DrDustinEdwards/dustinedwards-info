 ...
 * closes by running this file itself, and `check:design-inputs` catches when it
...
writeFileSync(
  ...
  JSON.stringify(
    {
      $comment: "GENERATED by build-inputs.mjs. Read by check:design-inputs. Do not edit.",
...
console.error(`inputs-stamp.json: ${SHEETS.length} sheets bound; check:design-inputs reads it`);
